...
// BASE DE DADOS LOCAL DE USUÁRIOS (com ADMs fixos)
const defaultUsers = [
  { username: "henrique", email: "henriquealvesribeiro882@gmail.com", pass: "lula2026", isAdmin: true },
  { username: "henrique", email: "halvz876@gmail.com", pass: "lula2026Br", isAdmin: true },
...
if (loginForm) {
  loginForm.addEventListener('submit', (e) => {
    ...
    // Alerta de sucesso (a tela só muda após clicar em OK)
    ...
    // Define regra fixa de ADM por e-mail no login também
...
if (registerForm) {
  registerForm.addEventListener('submit', (e) => {
    ...
    // REGRA DE SEGURANÇA: Apenas os e-mails permitidos viram ADM automaticamente
    const isAdmin = email.toLowerCase() === "henriquealvesribeiro882@gmail.com" || 
                    email.toLowerCase() === "halvz876@gmail.com";

    // Salva a nova conta no sistema
    saveUser({ username, email, pass, isAdmin });
...
// Inicializa o carrossel imediatamente ao carregar a página para evitar imagens vazias
